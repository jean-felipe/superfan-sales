      ...
      <div class="modal-wrapper">
       <div class="modal-card">
          <header class="modal-card-head">
            <p class="modal-card-title">Cadastro simples de categoria</p>
            <button class="delete" aria-label="close" @click="$emit('close')"></button>
          </header>
          <section class="modal-card-body">
            <input class="input is-hovered" type="text" placeholder="Digite o nome" v-model="newCategory.name">
          </section>
  ...
  methods: {
    submitForm() {
      axios.post('/api/v1/categories', this.newCategory)
        ...
        // .catch(() => {
        //   this.$swal("Que pena!", "Houve um problema na criação", "error")
        //     .then(() => {
        //       window.location = '/products/new'
        //     })
        // })
